...
const HERO_IMAGES = [
  ...
  "https://images.unsplash.com/photo-1533676802871-eca1ae998cd5?auto=format&fit=crop&q=80&w=2000",
  "https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&q=80&w=2000"
];
      ...
      <section id="intro" className={`intro section scroll-anim-section ${isIntroInView ? 'is-visible' : ''}`} ref={introRef}>
        <div className="container intro-grid">
          ...
          <div className="intro-image-wrap slide-up-img">
            <img src="https://images.unsplash.com/photo-1499856871958-5b9627545d1a?auto=format&fit=crop&q=80&w=800" alt="Serene view" className="intro-img" />
          </div>
        </div>
      </section>
      ...
      <section className={`featured-journey section bg-dark scroll-anim-section ${isJourneyInView ? 'is-visible' : ''}`} ref={journeyRef}>
        <div className="container journey-grid">
          <div className="journey-image-wrap slide-up-img">
            <img src="https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?auto=format&fit=crop&q=80&w=1200" alt="Aegean Sea" className="journey-img" />
          </div>
